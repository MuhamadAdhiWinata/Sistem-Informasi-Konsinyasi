...
Tabel 2.1 menyajikan perbandingan keenam penelitian tersebut berdasarkan metode, hasil, persamaan, dan perbedaan dengan SIKONS.

| No | Peneliti (Tahun) | Judul Penelitian | Metode | Hasil Penelitian | Persamaan | Perbedaan |
|:---|:-----------------|:-----------------|:-------|:-----------------|:----------|:----------|
| 1 | Bantang dan Nugroho (2023) | Rancang bangun sistem informasi pengelolaan barang berbasis web menggunakan framework Nuxt JS | Waterfall; Black Box Testing | Sistem pengelolaan stok masuk/keluar dan laporan inventaris berfungsi sesuai kebutuhan | Framework Nuxt JS; metode Waterfall dan Black Box Testing | Fokus pada stok internal perusahaan, tidak mencakup siklus konsinyasi (penerimaan, penyaluran, opname, rekonsiliasi) |
| 2 | Setiyani (2019) | Pengujian sistem informasi inventory pada perusahaan distributor farmasi menggunakan metode black box testing | Black Box Testing (equivalence partitioning, boundary value analysis) | Black Box Testing efektif mengidentifikasi cacat fungsional pada sistem inventory | Metode pengujian Black Box Testing | Fokus pada pengujian, tidak membangun sistem baru |
| 3 | Fauzan dan Noprisson (2020) | Analisa dan perancangan aplikasi e-commerce jasa titip oleh-oleh produk tradisional | PIECES Analysis | Analisis kebutuhan sistem titip jual yang mencakup kebutuhan pengguna dan fungsional sistem | Domain bisnis titip jual (konsinyasi) yang sama-sama menangani penitipan barang | Model bisnis B2C, hanya sampai tahap analisis dan perancangan, belum diimplementasikan |
| 4 | Febyanti (2025) | Peran sistem informasi akuntansi dalam rangka meningkatkan kinerja karyawan divisi purchasing di PT Semen Indonesia Distributor | Kualitatif deskriptif | Sistem informasi akuntansi mempercepat proses kerja, meminimalisir kesalahan administrasi, dan meningkatkan akurasi pelaporan | Relevansi dengan modul rekonsiliasi keuangan pada SIKONS | Fokus pada analisis peran sistem yang sudah ada, bukan perancangan dan pembangunan sistem baru |
| 5 | Putri (2024) | Perancangan sistem pencatatan transaksi dan pelaporan keuangan menggunakan Google Spreadsheet pada Percetakan Tunas Karya | Studi kasus; perancangan sistem | Peningkatan efisiensi pencatatan dari manual ke spreadsheet; keterbatasan akses multi-pengguna dan otomatisasi | Urgensi digitalisasi pencatatan UMKM sebagai dasar pengembangan SIKONS | Solusi berbasis spreadsheet tanpa basis data relasional, kontrol akses, dan workflow otomatis |
| 6 | Repository Universitas Nurul Fikri (2020) | Implementasi sistem informasi pemasaran berbasis web dalam kegiatan jasa titip barang ekspor impor pada bisnis Tourgether.in | Implementasi sistem berbasis web | Sistem titip barang berbasis web meningkatkan efektivitas operasional | Domain penitipan barang; validasi bahwa platform web merupakan solusi tepat untuk digitalisasi titip barang | Belum mencakup skema harga bertingkat (pabrik, grosir, retail) dan rekonsiliasi keuangan |
