  ...
  <div class="min-h-screen bg-zinc-50 print:bg-white">
    ...
    <template v-else-if="data">
      <div class="no-print max-w-4xl mx-auto mb-6 pt-6 px-4 flex items-center justify-between">
        <UButton icon="i-heroicons-arrow-left" color="gray" variant="ghost" size="sm" :to="`/penyaluran/${data.id}`">
          Kembali
        </UButton>
      ...
      <div id="print-area" class="max-w-4xl mx-auto bg-white p-8 print:p-6 print:shadow-none shadow-lg" style="font-family: 'Times New Roman', Times, serif;">
        ...
        <div style="text-align:center; margin-bottom: 4px;">
          <div style="font-size:14pt; font-weight:bold; text-transform:uppercase;">FAKTUR TITIP JUAL</div>
          <div style="font-size:11pt;">Nomor Dokumen: {{ data.faktur?.nomorFaktur || '-' }}</div>
        </div>
        ...
        <table style="width:100%; font-size:11pt; border-collapse:collapse;">
          <tbody><tr>
            <td style="width:50%; vertical-align:top;">
              ...
              <div v-if="data.telepon">Telepon    : {{ data.telepon }}</div>
            </td>
            <td style="width:50%; vertical-align:top;">
      ...
      <table style="width:100%; border-collapse:collapse; font-size:10pt;">
        ...
        <div style="font-size:11pt;">
          ...
          <div style="font-size:10pt; color:#444;">
            Barang titip jual telah diperiksa secara fisik dan dinyatakan sesuai dengan jumlah serta kondisi yang tercantum di atas. Faktur ini merupakan dokumen sah hasil transaksi penyaluran barang konsinyasi.
          </div>
        </div>
        ...
        <table style="width:100%; border-collapse:collapse; font-size:11pt;">
          <tbody><tr>
            <td style="width:33%; text-align:center; vertical-align:top;">
              ...
              <div style="border-top:1px solid #222; display:inline-block; padding-top:4px;">
                <b>{{ data.dibuatOleh }}</b>
              </div>
            </td>
            <td style="width:33%; text-align:center; vertical-align:top;">
              <div>Diketahui Oleh</div>
              <div style="font-weight:bold; margin-top:4px;">(Sales Lapangan),</div>
              <div style="height:60px;"></div>
              <div style="border-top:1px solid #222; display:inline-block; padding-top:4px;">
                <b>{{ data.sales }}</b>
              </div>
            ...
            <td style="width:33%; text-align:center; vertical-align:top;">
              ...
              <div style="font-weight:bold; margin-top:4px;">(Pihak Mitra),</div>
              <div style="height:60px;"></div>
              <div style="border-top:1px solid #222; display:inline-block; padding-top:4px;">
                <b>{{ data.mitra }}</b>
              </div>
...
async function downloadPdf() {
  ...
  try {
    ...
    html2pdf()
      .set({
        margin: [10, 10, 10, 10],
        filename: `faktur-${data.value?.faktur?.nomorFaktur || 'unknown'}.pdf`,
